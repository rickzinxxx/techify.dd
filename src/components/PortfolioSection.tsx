              ...
              {filteredProjects.map((proj) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <button
                      onClick={() => {
                        if ((proj.id === 'yuffie' || proj.id === 'mugsys-mugs') && onLaunchDemo) {
                    ...
                    >
                      ...
                      <span>{(proj.id === 'yuffie' || proj.id === 'mugsys-mugs') ? 'ABRIR DEMO LIVE ⚡' : 'ACESSAR SITE DO PROJETO'}</span>
                    </button>
                  </div>
            ...
            >
              ...
              <div className="mt-6">
                ...
                <div className="mt-8 flex gap-3">
                  ...
                  {((selectedProject.id === 'yuffie' || selectedProject.id === 'mugsys-mugs') && onLaunchDemo) ? (
                    <button
                      onClick={() => {
